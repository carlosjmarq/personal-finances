import { EmbossedButton } from "@/components/Buttons/EmbossedButton";
  ...
  return (
    <header className="bg-white border-b-2 border-black">
      <nav className="flex justify-between items-center gap-x-1 px-4 md:px-4 min-h-12 h-[6.3vh]">
        <section className="flex items-center gap-x-1 bg-mint-700 border-[2px] border-black px-2 py-1 -rotate-2 hover:-rotate-1 transition-all duration-200">
