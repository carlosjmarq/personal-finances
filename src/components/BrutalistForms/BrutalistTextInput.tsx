import type { BrutalistTextInputProps } from "@/types/BrutalistFormTypes";
import React, { forwardRef } from "react";

export const BrutalistTextInput = forwardRef<
  HTMLInputElement,
  BrutalistTextInputProps
>(
  (
    {
      label,
...
BrutalistTextInput.displayName = "BrutalistTextInput";
